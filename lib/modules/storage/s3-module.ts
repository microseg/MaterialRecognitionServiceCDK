...
export class S3Module extends Construct {
  public readonly customerImagesBucket: s3.Bucket;
  ...
  constructor(scope: Construct, id: string, props: S3ModuleProps = {}) {
    ...
    // Create S3 bucket for customer images
    this.customerImagesBucket = new s3.Bucket(this, 'CustomerImagesBucket', {
      bucketName,
    ...
    if (props.enableAccessLogging) {
      ...
      this.customerImagesBucket.addLifecycleRule({
        id: 'AccessLogging',
        enabled: true,
        transitions: [
          {
